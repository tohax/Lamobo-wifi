...
//	T_S64 disk_size;
	...
	//disk_size = (signed long long)(T_U32)(disk_statfs.f_bavail) * (T_S64)(T_U32)(disk_statfs.f_bsize);
	//printf("f_bavail = %ld, f_bsize = %ld disk_size = %lld \n", disk_statfs.f_bavail, disk_statfs.f_bsize,
	//				disk_size);
	*f_bavail = disk_statfs.f_bavail;
	*f_bsize = disk_statfs.f_bsize;
	return 0;
